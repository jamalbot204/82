...
const AdvancedAudioPlayer: React.FC<AdvancedAudioPlayerProps> = memo(({
  ...
  return (
    <div
      className="aurora-panel text-gray-200 p-2 shadow-xl border-b border-aurora-border flex flex-col relative z-50"
      role="toolbar"
    ...
    >
      <div className="flex items-center w-full space-x-1.5 sm:space-x-2">
        ...
        <div className="flex items-center space-x-1 sm:space-x-2 flex-grow justify-center" dir="ltr">
            ...
            className="p-1.5 sm:p-2 text-gray-200 bg-white/10 rounded-full transition-all hover:shadow-[0_0_10px_2px_rgba(90,98,245,0.6)] disabled:opacity-50 disabled:cursor-not-allowed focus:outline-none focus:ring-2 ring-aurora-accentPrimary focus:ring-offset-2 focus:ring-offset-black"
