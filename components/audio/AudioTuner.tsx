...
const AudioTuner: React.FC<AudioTunerProps> = memo(({ triggerRef, onClose }) => {
  ...
  return createPortal(
    <div ref={panelRef} style={style} className="w-64 bg-black/90 backdrop-blur-md border border-aurora-border rounded-lg p-4 shadow-xl z-50 animate-fade-in text-left">
