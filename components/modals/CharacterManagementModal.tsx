  ...
  return (
    <div className="fixed inset-0 bg-black/60 z-50 flex justify-center items-center p-4 backdrop-blur-md" onClick={closeCharacterManagementModal}>
      <div className="aurora-panel p-6 rounded-lg shadow-2xl w-full sm:max-w-lg max-h-[90vh] flex flex-col text-gray-200" onClick={(e) => e.stopPropagation()}>
        ...
        <fieldset disabled={areButtonsDisabled} className="border-t border-aurora-border pt-4 flex-shrink-0">
          ...
          <div className="flex justify-end space-x-2 mt-4">
            ...
            <button 
                ...
                className="px-4 py-2 text-sm bg-aurora-accentPrimary text-white rounded-md disabled:opacity-50 transition-shadow hover:shadow-[0_0_12px_2px_rgba(90,98,245,0.6)]"
            >
        ...
        <div className="mt-6 flex justify-end flex-shrink-0 border-t border-aurora-border pt-4">
