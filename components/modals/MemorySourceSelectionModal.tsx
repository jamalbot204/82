  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Chat List */}
        <div className="flex-grow min-h-0 overflow-y-auto border border-aurora-border rounded-md bg-black/20 p-1 custom-scrollbar mb-4">
        ...
        <div className="pt-4 border-t border-aurora-border flex-shrink-0 mb-4">
        ...
        <div className="pt-2 border-t border-aurora-border flex-shrink-0">
        ...
        <div className="mt-6 flex justify-between items-center flex-shrink-0">
            ...
            <div className="flex gap-3">
                ...
                <button 
                    onClick={handleSave}
                    disabled={areButtonsDisabled}
                    className="px-4 py-2 text-sm font-medium text-white bg-aurora-accentPrimary rounded-md transition-shadow hover:shadow-[0_0_12px_2px_rgba(90,98,245,0.6)] disabled:opacity-60"
                >
                    {t.save}
                </button>
            </div>
