...
const ReasoningSetupModal: React.FC = memo(() => {
    ...
    const footerButtons = (
        <>
            ...
            <button onClick={handleSave} className="px-4 py-2 text-sm font-medium text-white bg-aurora-accentPrimary rounded hover:shadow-lg hover:shadow-blue-500/30 flex items-center">
