  ...
  const footerButtons = (
    <>
        ...
        <button
            ...
            className="px-4 py-2 text-sm font-medium text-white bg-aurora-accentPrimary rounded-md transition-shadow hover:shadow-[0_0_12px_2px_rgba(90,98,245,0.6)] disabled:opacity-60 flex items-center"
        >
        ...
        <div className="space-y-4">
            ...
            <div className="relative p-4 rounded-r-xl rounded-l-md border border-white/10 border-l-4 border-l-amber-500 bg-gradient-to-r from-amber-500/5 to-transparent">
                ...
                <>
                    ...
                    />
                    <div className="max-h-64 overflow-y-auto border border-aurora-border rounded-md p-1 space-y-1 bg-black/20 custom-scrollbar">
