        ...
        <div className="p-4 border-t border-aurora-border bg-[rgba(13,15,24,0.5)] flex flex-col sm:flex-row justify-between items-center space-y-3 sm:space-y-0">
            ...
            <div className="flex space-x-3 w-full sm:w-auto">
                ...
                <button
                    ...
                    type="button"
                    disabled={areButtonsDisabled}
                    className="flex-1 sm:flex-none px-6 py-2 text-sm font-medium text-white bg-aurora-accentPrimary rounded-md hover:shadow-[0_0_12px_2px_rgba(90,98,245,0.6)] transition-all disabled:opacity-60"
                >
                    {t.apply}
                </button>
            </div>
