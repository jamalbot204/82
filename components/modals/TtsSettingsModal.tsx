    ...
    <>
      <div className="fixed inset-0 bg-black/60 z-50 flex justify-center items-center p-4 backdrop-blur-md" onClick={handleClose}>
        <div className="aurora-panel p-0 rounded-lg shadow-2xl w-full sm:max-w-md max-h-[90vh] flex flex-col text-gray-200 relative overflow-hidden" onClick={(e) => e.stopPropagation()}>
          ...
          <div className="p-5 flex justify-between items-center bg-[rgba(13,15,24,0.3)] border-b border-aurora-border">
          ...
          <div className="p-4 border-t border-aurora-border bg-[rgba(13,15,24,0.5)] flex flex-col sm:flex-row justify-between items-center space-y-3 sm:space-y-0">
            ...
            <div className="flex space-x-3 w-full sm:w-auto">
              ...
              <button onClick={handleApplySettings} disabled={areButtonsDisabled} type="button" className="flex-1 sm:flex-none px-6 py-2 text-sm font-medium text-white bg-aurora-accentPrimary rounded-md hover:shadow-[0_0_12px_2px_rgba(90,98,245,0.6)] transition-all disabled:opacity-60">{t.applyTtsSettings}</button>
            </div>
          </div>
        </div>
      </div>
