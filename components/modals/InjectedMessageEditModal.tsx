...
const InjectedMessageEditModal: React.FC = () => {
  ...
  return (
    ...
    >
      <div 
        className={`aurora-panel p-6 rounded-lg shadow-2xl w-full max-w-2xl flex flex-col relative transition-all ${isDragging ? 'ring-2 ring-aurora-accentPrimary bg-black/40' : ''}`}
        ...
        {isDragging && (
            <div className="absolute inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm pointer-events-none rounded-lg">
                <div className="text-white font-bold text-lg flex items-center animate-bounce">
                    <DocumentIcon className="w-8 h-8 mr-3 text-aurora-accentPrimary" />
        ...
        <footer className="flex justify-between items-center">
          ...
          <div className="flex space-x-3">
            ...
            <button
                ...
                className="px-5 py-2.5 text-sm font-medium text-white bg-aurora-accentPrimary rounded-md transition-all hover:shadow-[0_0_12px_2px_rgba(90,98,245,0.6)] disabled:opacity-50 disabled:cursor-not-allowed flex items-center"
            >
