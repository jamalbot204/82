    ...
    >
      <div className="aurora-panel p-6 rounded-lg shadow-2xl w-full sm:max-w-lg max-h-[90vh] flex flex-col text-gray-200" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="flex justify-end space-x-3 flex-shrink-0">
          ...
          <button onClick={handleSave} disabled={areButtonsDisabled} className="px-4 py-2 text-sm bg-aurora-accentPrimary text-white rounded-md transition-shadow hover:shadow-[0_0_12px_2px_rgba(90,98,245,0.6)] disabled:opacity-60">
            {t.saveInfo}
          </button>
        </div>
      </div>
