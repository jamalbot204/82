        ...
        <>
            <div className="fixed inset-0 bg-black/60 z-40 flex justify-center items-center p-4 backdrop-blur-md" onClick={closeSettingsPanel}>
                ...
                >
                    ...
                    {/* Tabs Navigation */}
                    <div className="flex border-b border-aurora-border px-5 bg-[rgba(13,15,24,0.3)]">
                        {[
                            ...
                            <button
                                ...
                                className={`flex-1 pb-3 text-sm font-medium border-b-2 flex items-center justify-center transition-colors duration-200 ${
                                    activeTab === tab.id 
                                    ? 'border-aurora-accentPrimary text-aurora-accentPrimary' 
                    ...
                    <div className="p-4 border-t border-aurora-border bg-[rgba(13,15,24,0.5)] flex flex-col sm:flex-row justify-between items-center space-y-3 sm:space-y-0">
                        ...
                        <button onClick={handleSubmit} className="w-full sm:w-auto px-6 py-2 text-sm font-bold text-white bg-aurora-accentPrimary rounded-md shadow-lg hover:shadow-[0_0_15px_rgba(90,98,245,0.5)] transition-all transform hover:scale-105 flex items-center justify-center">
