    ...
    return (
        <>
            <button
                ...
                className={`p-2 rounded-full transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-aurora-accentPrimary disabled:opacity-50 ${isOpen ? 'text-aurora-accentPrimary bg-aurora-accentPrimary/10' : 'text-gray-400 hover:text-white hover:bg-white/10'}`}
                title="Tools"
