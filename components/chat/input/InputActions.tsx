        ...
        return (
            <div className="flex flex-col gap-1 pb-1.5">
                ...
                <button 
                    ...
                    className={`p-2 rounded-full transition-all duration-200 hover:scale-105 active:scale-95 disabled:opacity-50 disabled:hover:scale-100 ${isAttachMenuOpen ? 'text-aurora-accentPrimary bg-aurora-accentPrimary/10' : 'text-gray-400 hover:text-white hover:bg-white/10'}`} 
                    title={t.attachFiles}
                >
                ...
                {isCharacterMode && (
                    <button 
                        ...
                        className={`p-2 rounded-full transition-all duration-200 hover:scale-105 active:scale-95 disabled:opacity-50 disabled:hover:scale-100 ${isInfoInputModeActive ? 'bg-yellow-500/20 text-yellow-300' : 'text-gray-400 hover:text-white hover:bg-white/10'}`} 
            ...
            <div className="flex flex-col gap-1 pb-1.5 items-center">
                {!isCharacterMode && showContinueFlow && (
                    <button 
                        ...
                        className="p-2 text-teal-400 hover:text-teal-300 hover:bg-teal-500/10 rounded-full transition-all duration-200 hover:scale-105 active:scale-95 disabled:opacity-30 disabled:hover:scale-100" 
                ...
                <button
                    ...
                    className={`p-2 rounded-full transition-all duration-200 hover:scale-105 active:scale-95 disabled:opacity-50 disabled:hover:scale-100
                        ${isRecording 
                ...
                {(isLoading || isAutoSendingActive) ? (
                    <button 
                        onClick={onCancel} 
                        className="p-2.5 bg-red-500 text-white rounded-full hover:bg-red-600 transition-all duration-200 hover:scale-105 active:scale-95 shadow-lg shadow-red-500/30" 
                        aria-label={t.stop}
                    >
                    ...
                    <button 
                        ...
                        className={`p-2.5 bg-aurora-accentPrimary text-white rounded-full hover:bg-blue-600 transition-all duration-200 hover:scale-105 active:scale-95 shadow-lg shadow-blue-500/30 disabled:opacity-50 disabled:shadow-none disabled:hover:scale-100 ${isCharacterMode ? 'hidden' : ''}`} 
