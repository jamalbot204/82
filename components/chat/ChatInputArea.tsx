    ...
    return (
        <div className="sticky bottom-0 z-20 pb-6 px-4">
            <div className="mx-auto w-full max-w-4xl relative">
                ...
                <div 
                    className={`border transition-all duration-300 relative overflow-hidden rounded-2xl ${isDragging ? 'border-dashed border-aurora-accentPrimary bg-aurora-accentPrimary/10 ring-2 ring-aurora-accentPrimary/50 scale-[1.01]' : 'border-aurora-border bg-aurora-inputBg backdrop-blur-md shadow-[0_8px_32px_rgba(0,0,0,0.2)] hover:shadow-[0_8px_32px_rgba(0,0,0,0.3)]'} ${isLoading ? 'ring-1 ring-aurora-accentPrimary/50' : ''}`}
